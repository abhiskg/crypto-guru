    ...
    <header className={` custom-container mx-auto h-[4.5rem]`}>
      <nav className=" flex h-full  items-center justify-between">
        <div className="text-3xl font-extrabold">
          ...
          <span className="text-primary"> GURU DEALS</span>
        </div>

        <ul
          className={`hidden gap-6 font-medium  ${
        ...
        <ul className="hidden items-center gap-4 font-medium sm:flex">
          <li className=" flex cursor-pointer items-center gap-1 text-primary">
            <svg
